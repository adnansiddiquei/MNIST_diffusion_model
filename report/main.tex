...
The MNIST classifier model is a CNN composed of 4 \inlinecode{CNNBlocks} ($[32, 64, 128, 64]$ channels per block) following by aa
...
This classifier was trained for XXX epochs with a batch size of 128 and a learning rate of $2 \times 10^{-4}$ using the Adam optimiser.
The loss function used was the cross-entropy loss function and the test set classification accuracy was reached XXXX on
the final epoch.
